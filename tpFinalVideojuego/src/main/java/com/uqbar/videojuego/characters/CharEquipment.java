...
public class CharEquipment {
	...
	/**
	 * Recine un Equipment por par�metro y lo agrega al CharEquipment segun su EquipType.
	 * Si ya hab�a un Equipment de ese EquipType, es reemplazado por el nuevo. 
	 ...
	 * si ya hab�a uno en ese lugar, se acomoda en la "offHand". 
	 * @param aEquipment
	 */
