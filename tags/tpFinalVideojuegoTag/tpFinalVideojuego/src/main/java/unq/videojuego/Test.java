...
public class Test {
	...
	public static void main(String[] args) {
		...
		equip.putEquipment(new Equipment("Sword", EquipType.ONEHANDED, new StatsContainer(0, 0, 2, 4, 1, 0, 0),1, 1, 100));
		equip.putEquipment(new Equipment("Sword", EquipType.ONEHANDED, new StatsContainer(0, 0, 2, 4, 1, 0, 0),1, 1, 100));
		...
		hache.equip(new Equipment("Iron Axe", EquipType.TWOHANDED, new StatsContainer(0, 0, 0, 100, 50, 0, 0), 1, 1, 200));
		/*for (int i = 0; i < 5; i++) {
			enemy.attack(hache);
			System.out.println(hache.getStats());
			System.out.println(enemy.getStats());
